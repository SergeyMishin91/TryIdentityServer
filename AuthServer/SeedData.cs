...
namespace AuthServer
{
    public class SeedData
    {
        ...
        private static void EnsureSeedData(ConfigurationDbContext context)
        {
            ...
            {
                foreach (var client in Configuration.Configuration.Clients.ToList())
                {
            ...
            {
                foreach (var resource in Configuration.Configuration.IdentityResources.ToList())
                {
            ...
            {
                foreach (var resource in Configuration.Configuration.ApiScopes.ToList())
                {
            ...
            {
                foreach (var resource in Configuration.Configuration.ApiResources.ToList())
                {
